...
class User extends VuFindUser
{
    ...
    public function saveResourceSemesterApparatus(
        ...
        $linkTable->createOrUpdateLinkSemesterApparatus($resource->id, $this->id, $list->id, $notes, $annotationStudents, $annotationStaff, $scanStatus, $orderStatus, $physicalAvailable);
